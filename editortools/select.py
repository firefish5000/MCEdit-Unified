...
class CBCommandsOptionsPanel(ToolOptions):
    def __init__(self):
        ...
        groupchain = Row((Label("Grouping"),CheckBoxLabel("Chains",
                                        ...
                                        ref=config.commands.groupchains)),spacing=2)
        ...
        col = Column((Label("Command Blocks Commands Options"), sortingRow, groupchain, empty, space, empty, fileFormat, okButton),
                     spacing=2)
